...
def read_and_save_data():
    ...
    db_url = "jdbc:postgresql://localhost:5432/projek_akhir_msib"
    db_properties = {
        "user": "postgres",
        "password": "Aditya_912",
    ...
    order_df = spark.read.jdbc(url=db_url, table='"order_data"', properties=db_properties)  # Quoted table name
